/*
 * @Author: 黄遥
 * @Date: 2020-04-02 17:08:56
 * @LastEditors: 黄遥
 * @LastEditTime: 2020-04-03 15:58:46
 ...
 plugins: [
   ...
   */
   new HtmlWebpackPlugin({
    ...
    html-loader 编译后产生的字符串，会由 html-wewebpack-plugin 储存为 html 文件到输出目录，默认文件名为 index.html
...
如果是修改 css，甚至不需要刷新页面，直接生效。这让像弹出框这种需要点击交互后才会出来的东西调试起来方便很多。
